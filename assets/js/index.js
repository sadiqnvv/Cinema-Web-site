...
// Импорт всех функ из других файлов
...
const addHeroSlide = () => {
  ...
  const sliderStart = (e) => {
    const controlElement = e.currentTarget;

    lastSliderItem.classList.remove("active");
    lastSliderControl.classList.remove("active");

    const index = Number(controlElement.getAttribute("slider-control"));
    sliderItems[index].classList.add("active");
    controlElement.classList.add("active");

    lastSliderItem = sliderItems[index];
    lastSliderControl = controlElement;
  };

  addEventOfElements(sliderControls, "click", sliderStart);
};
